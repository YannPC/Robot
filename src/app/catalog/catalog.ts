...
export class Catalog {
  ...
  constructor(
    private cartSvc:CartServiceClass, 
    private productSvc:Product,
    private router:Router,
    private route: ActivatedRoute
  ) {

//we are going to pull the data from the server using HTTP request, get that json, and then load is into
//that same property. We will do from a service instead of the component 
/*
  this.products = [
